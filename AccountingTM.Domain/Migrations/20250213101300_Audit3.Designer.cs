...
namespace AccountingTM.Domain.Migrations
{
    ...
    [Migration("20250213101300_Audit3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.ApplicationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.AuditLogDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.CommentsOnTheApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CommentsOnTheApplications");
                });
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.Directory.Model", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.Tables.TechnicalEquipmentHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.ApplicationHistory", b =>
                {
                    b.HasOne("AccountingTM.Domain.Models.Application", "Application")
                        .WithMany()
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.AuditLogDetail", b =>
                {
                    b.HasOne("AccountingTM.Domain.Models.AuditLog", "AuditLog")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("AccountingTM.Domain.Models.Tables.Characteristic", b =>
                {
                    ...
                    b.HasOne("AccountingTM.Domain.Models.Directory.Model", "Model")
                        .WithMany()
