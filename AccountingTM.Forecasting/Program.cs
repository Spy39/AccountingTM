...
var input = new ConsumableAnalisisModel
{
	TypeConsumable = consumables[0].TypeConsumable,
	Brand = consumables[0].Brand,
	Model = consumables[0].Model,
	Mounth = 12,
	Year = 2024
};
...
Console.WriteLine(prediction.Quantity);